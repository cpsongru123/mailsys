...
<div class="sendmail container">
    ...
    <form  class="sform" id="sendmailForm"  method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input id="subj" type="text" name="email_subject"  class="form-control" value="回复：${replymsg.mailMsgSubject}">
        </div>
        <div class="form-group">
            ...
            <textarea id="email_content" name="email_content" class="form-control">
                ...
                在${replymsg.mailMsgDate} ${replymsg.mailMsgFrom}写道：${replymsg.mailMsgSubject}
            </textarea>
