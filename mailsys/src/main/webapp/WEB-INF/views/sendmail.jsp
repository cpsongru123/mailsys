...
<div class="sendmail container">
    ...
    <form  class="sform" id="sendmailForm"  method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input id="receiver" type="text" name="email_recipientTo" class="form-control" value="">
        </div>
        <div class="form-group">
            ...
            <select id="sel" name="email_from" class="form-control">
                ...
                <c:forEach items="${bindlist}" var="vo">
                    <option value="${vo.mailAcc}">${vo.mailAcc}</option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="subj" type="text" name="email_subject"  class="form-control" value="">
        </div>
        <div class="form-group">
